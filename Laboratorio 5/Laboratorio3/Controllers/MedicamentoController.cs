...
namespace Laboratorio3.Controllers
{
    public class MedicamentoController : Controller
    {
        ...
        public static string nombreArchivo = @"C:\Users\user\Desktop\Laboratorio4\MOCK_DATA (4).csv";
        ...
        public static ArbolB arbolMedicinas = new ArbolB();
        ...
        public ActionResult agregarPedido(Medicamento received) 
        {
            ...
            //arbolMedicinas.disminuirValor(received);
